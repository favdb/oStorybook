...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER Storybook
...
!define MUI_FINISHPAGE_RUN_TEXT "Start Storybook"
...
OutFile "storybook-3.1.0-win32.exe"
InstallDir $PROGRAMFILES\Storybook
CRCCheck on
XPStyle on
ShowInstDetails show
VIProductVersion 3.1.0.0
VIAddVersionKey ProductName Storybook
...
Section -Main SEC0000
	...
	Call GetJRE
	Pop $R0
	CreateShortcut $INSTDIR\Storybook.lnk $R0 "-Xmx256m -jar lib/storybook.jar" $INSTDIR\storybook-icon.ico
...
Section /o -un.Main UNSEC0000
    ...
    Delete /REBOOTOK $INSTDIR\Storybook.lnk
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Storybook.lnk"
...
;                   InstallDirectory: $INSTDIR "
  ExecShell "" "$INSTDIR\Storybook.lnk"
FunctionEnd
