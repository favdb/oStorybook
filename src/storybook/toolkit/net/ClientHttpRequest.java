 ...
 * form data, including files. Cookies can be added to be included in the request. </p>
 *
...
public class ClientHttpRequest {
	 ...
	 * value); if a value is a file, the file is uploaded, otherwise it is stringified and sent in the request
	 * @throws IOException
	 */
